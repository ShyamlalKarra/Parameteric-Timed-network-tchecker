...
/**
 ** \file /Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/system_parser/system.tab.hh
...
#ifndef YY_SPYY_USERS_SHYAMKARRA_DESKTOP_PARAMETRIC_GIT_REPOS_PV_OF_GENERAL_DTN_CEGAR_CEGAR_IMPLEMENTATION_TCHECKER_RUNNER_TCHECKER_EDITED_BUILD_SRC_PARSING_SYSTEM_PARSER_SYSTEM_TAB_HH_INCLUDED
# define YY_SPYY_USERS_SHYAMKARRA_DESKTOP_PARAMETRIC_GIT_REPOS_PV_OF_GENERAL_DTN_CEGAR_CEGAR_IMPLEMENTATION_TCHECKER_RUNNER_TCHECKER_EDITED_BUILD_SRC_PARSING_SYSTEM_PARSER_SYSTEM_TAB_HH_INCLUDED
...
#line 64 "/Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/system_parser/system.tab.hh"
...
#line 213 "/Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/system_parser/system.tab.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // attr
      char dummy2[sizeof (std::shared_ptr<tchecker::parsing::attr_t>)];

      // sync_constraint
      char dummy3[sizeof (std::shared_ptr<tchecker::parsing::sync_constraint_t>)];
      ...
      char dummy5[sizeof (std::vector<std::shared_ptr<tchecker::parsing::sync_constraint_t>>)];

      // integer
      char dummy6[sizeof (tchecker::integer_t)];

      // attr_list
      // non_empty_attr_list
      char dummy7[sizeof (tchecker::parsing::attributes_t)];
    ...
    TOK_EOL = 265,                 // "\n"
    TOK_EVENT = 266,               // "event"
    TOK_ID = 267,                  // "identifier"
    TOK_INT = 268,                 // "int"
    TOK_INTEGER = 269,             // "integer value"
    TOK_LOCATION = 270,            // "location"
    TOK_PROCESS = 271,             // "process"
    TOK_SYNC = 272,                // "sync"
    TOK_SYSTEM = 273,              // "system"
    TOK_TEXT = 274                 // "text value"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_TOK_EDGE = 9,                          // "edge"
        S_TOK_EOL = 10,                          // "\n"
        S_TOK_EVENT = 11,                        // "event"
        S_TOK_ID = 12,                           // "identifier"
        S_TOK_INT = 13,                          // "int"
        S_TOK_INTEGER = 14,                      // "integer value"
        S_TOK_LOCATION = 15,                     // "location"
        S_TOK_PROCESS = 16,                      // "process"
        S_TOK_SYNC = 17,                         // "sync"
        S_TOK_SYSTEM = 18,                       // "system"
        S_TOK_TEXT = 19,                         // "text value"
        S_YYACCEPT = 20,                         // $accept
        S_system = 21,                           // system
        S_22_1 = 22,                             // $@1
        S_declaration_list = 23,                 // declaration_list
        S_non_empty_declaration_list = 24,       // non_empty_declaration_list
        S_declaration = 25,                      // declaration
        S_attr_list = 26,                        // attr_list
        S_non_empty_attr_list = 27,              // non_empty_attr_list
        S_attr = 28,                             // attr
        S_text_or_empty = 29,                    // text_or_empty
        S_sync_constraint_list = 30,             // sync_constraint_list
        S_sync_constraint = 31,                  // sync_constraint
        S_sync_strength = 32,                    // sync_strength
        S_end_declaration = 33,                  // end_declaration
        S_eol_sequence = 34,                     // eol_sequence
        S_integer = 35,                          // integer
        S_uinteger = 36                          // uinteger
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_attr: // attr
        value.move< std::shared_ptr<tchecker::parsing::attr_t> > (std::move (that.value));
        break;

      case symbol_kind::S_sync_constraint: // sync_constraint
        value.move< std::shared_ptr<tchecker::parsing::sync_constraint_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_sync_constraint_list: // sync_constraint_list
        value.move< std::vector<std::shared_ptr<tchecker::parsing::sync_constraint_t>> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<tchecker::parsing::attr_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<tchecker::parsing::attr_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<tchecker::parsing::sync_constraint_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<tchecker::parsing::sync_constraint_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<tchecker::parsing::sync_constraint_t>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<tchecker::parsing::sync_constraint_t>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    ...
    parser_t (std::string const & filename_yyarg, std::shared_ptr<tchecker::parsing::system_declaration_t> & system_declaration_yyarg);
    virtual ~parser_t ();
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_attr: // attr
        value.copy< std::shared_ptr<tchecker::parsing::attr_t> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_sync_constraint: // sync_constraint
        value.copy< std::shared_ptr<tchecker::parsing::sync_constraint_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_sync_constraint_list: // sync_constraint_list
        value.copy< std::vector<std::shared_ptr<tchecker::parsing::sync_constraint_t>> > (YY_MOVE (that.value));
        break;
...
#line 1886 "/Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/system_parser/system.tab.hh"




#endif // !YY_SPYY_USERS_SHYAMKARRA_DESKTOP_PARAMETRIC_GIT_REPOS_PV_OF_GENERAL_DTN_CEGAR_CEGAR_IMPLEMENTATION_TCHECKER_RUNNER_TCHECKER_EDITED_BUILD_SRC_PARSING_SYSTEM_PARSER_SYSTEM_TAB_HH_INCLUDED
