...
/**
 ** \file /Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/program_parser/program.tab.hh
...
#ifndef YY_PPYY_USERS_SHYAMKARRA_DESKTOP_PARAMETRIC_GIT_REPOS_PV_OF_GENERAL_DTN_CEGAR_CEGAR_IMPLEMENTATION_TCHECKER_RUNNER_TCHECKER_EDITED_BUILD_SRC_PARSING_PROGRAM_PARSER_PROGRAM_TAB_HH_INCLUDED
# define YY_PPYY_USERS_SHYAMKARRA_DESKTOP_PARAMETRIC_GIT_REPOS_PV_OF_GENERAL_DTN_CEGAR_CEGAR_IMPLEMENTATION_TCHECKER_RUNNER_TCHECKER_EDITED_BUILD_SRC_PARSING_PROGRAM_PARSER_PROGRAM_TAB_HH_INCLUDED
...
#line 64 "/Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/program_parser/program.tab.hh"
...
#line 213 "/Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/program_parser/program.tab.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // binary_formula
      // term
      char dummy2[sizeof (std::shared_ptr<tchecker::expression_t>)];

      // lvalue_term
      char dummy3[sizeof (std::shared_ptr<tchecker::lvalue_expression_t>)];
      ...
      // simple_statement
      // assignment
      char dummy4[sizeof (std::shared_ptr<tchecker::statement_t>)];

      // variable_term
      char dummy5[sizeof (std::shared_ptr<tchecker::var_expression_t>)];
      ...
      // integer
      char dummy7[sizeof (tchecker::integer_t)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_binary_formula = 47,                   // binary_formula
        S_predicate_operator = 48,               // predicate_operator
        S_term = 49,                             // term
        S_lvalue_term = 50,                      // lvalue_term
        S_variable_term = 51,                    // variable_term
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_term: // term
        value.move< std::shared_ptr<tchecker::expression_t> > (std::move (that.value));
        break;

      case symbol_kind::S_lvalue_term: // lvalue_term
        value.move< std::shared_ptr<tchecker::lvalue_expression_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_assignment: // assignment
        value.move< std::shared_ptr<tchecker::statement_t> > (std::move (that.value));
        break;

      case symbol_kind::S_variable_term: // variable_term
        value.move< std::shared_ptr<tchecker::var_expression_t> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<tchecker::expression_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<tchecker::expression_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<tchecker::lvalue_expression_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<tchecker::lvalue_expression_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<tchecker::statement_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<tchecker::statement_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<tchecker::var_expression_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<tchecker::var_expression_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_binary_formula: // binary_formula
      case symbol_kind::S_term: // term
        value.template destroy< std::shared_ptr<tchecker::expression_t> > ();
        break;

      case symbol_kind::S_lvalue_term: // lvalue_term
        value.template destroy< std::shared_ptr<tchecker::lvalue_expression_t> > ();
        break;
      ...
      case symbol_kind::S_simple_statement: // simple_statement
      case symbol_kind::S_assignment: // assignment
        value.template destroy< std::shared_ptr<tchecker::statement_t> > ();
        break;

      case symbol_kind::S_variable_term: // variable_term
        value.template destroy< std::shared_ptr<tchecker::var_expression_t> > ();
        break;
    ...
    parser_t (std::string const & program_context_yyarg, std::shared_ptr<tchecker::expression_t> & expr_yyarg, std::shared_ptr<tchecker::statement_t> & stmt_yyarg);
    virtual ~parser_t ();
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_binary_formula: // binary_formula
      case symbol_kind::S_term: // term
        value.copy< std::shared_ptr<tchecker::expression_t> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_lvalue_term: // lvalue_term
        value.copy< std::shared_ptr<tchecker::lvalue_expression_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_simple_statement: // simple_statement
      case symbol_kind::S_assignment: // assignment
        value.copy< std::shared_ptr<tchecker::statement_t> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_variable_term: // variable_term
        value.copy< std::shared_ptr<tchecker::var_expression_t> > (YY_MOVE (that.value));
        break;
  ...
  parser_t::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_binary_formula: // binary_formula
      case symbol_kind::S_term: // term
        value.move< std::shared_ptr<tchecker::expression_t> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_lvalue_term: // lvalue_term
        value.move< std::shared_ptr<tchecker::lvalue_expression_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_simple_statement: // simple_statement
      case symbol_kind::S_assignment: // assignment
        value.move< std::shared_ptr<tchecker::statement_t> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_variable_term: // variable_term
        value.move< std::shared_ptr<tchecker::var_expression_t> > (YY_MOVE (s.value));
        break;
...
#line 2116 "/Users/shyamkarra/Desktop/Parametric-Git-Repos/PV-of-General-DTN/cegar/cegar-Implementation/tchecker-runner/tchecker-edited/build/src/parsing/program_parser/program.tab.hh"




#endif // !YY_PPYY_USERS_SHYAMKARRA_DESKTOP_PARAMETRIC_GIT_REPOS_PV_OF_GENERAL_DTN_CEGAR_CEGAR_IMPLEMENTATION_TCHECKER_RUNNER_TCHECKER_EDITED_BUILD_SRC_PARSING_PROGRAM_PARSER_PROGRAM_TAB_HH_INCLUDED
